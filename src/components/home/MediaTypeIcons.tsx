...
const MediaTypeIcons: React.FC = () => {
  return (
    <div className="flex justify-center space-x-8 w-full px-4 sm:px-6 md:px-8">
      <div className="flex flex-col items-center group transition-all duration-300 ease-in-out animate-fade-in" style={{ animationDelay: '100ms' }}>
      ...
      <div className="flex flex-col items-center group transition-all duration-300 ease-in-out animate-fade-in" style={{ animationDelay: '200ms' }}>
      ...
      <div className="flex flex-col items-center group transition-all duration-300 ease-in-out animate-fade-in" style={{ animationDelay: '300ms' }}>
      ...
      <div className="flex flex-col items-center group transition-all duration-300 ease-in-out animate-fade-in" style={{ animationDelay: '400ms' }}>
