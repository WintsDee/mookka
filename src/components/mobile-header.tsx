...
const MobileHeader = ({ title, children }: MobileHeaderProps) => {
  ...
  return (
    <div 
      className="mobile-header fixed left-0 right-0 flex justify-between items-center bg-background/95 backdrop-blur-md border-b border-border/10 z-50"
      style={{
        position: 'fixed',
        top: 0,
        left: 0,
    ...
    >
      <div className="w-full h-full flex justify-between items-center px-6 py-3">
