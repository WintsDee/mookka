...
const MobileHeader = ({ title, children }: MobileHeaderProps) => {
  ...
  return (
    <div className="mobile-header fixed top-0 left-0 right-0 flex justify-between items-center bg-background/90 backdrop-blur-sm px-6 py-4 h-16 z-50 border-b border-border/20">
